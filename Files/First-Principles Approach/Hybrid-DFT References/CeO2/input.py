...
set_aims_command(hpc="hawk-amd", basis_set="light", defaults=2020)

# Build molecule
TiO2an = read('CeO2Opt-pbe.traj@-1')
...
calc = get_aims_calculator(dimensions=3, k_grid=(8,8,8), xc='pbe0')
calc.set(
         #spin='none',
         #relativistic=('atomic_zora','scalar'),
         occupation_type=('gaussian','0.1'),
         plus_u_petukhov_mixing= 1,
         plus_u={'Ce':'4 f 0','O':'2 p 0'},
