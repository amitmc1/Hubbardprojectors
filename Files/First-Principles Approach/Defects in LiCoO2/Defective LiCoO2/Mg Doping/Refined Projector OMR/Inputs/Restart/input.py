...
import os
os.environ["AIMS_SPECIES_DIR"] = "/nfshome/store01/users/c.c21127846/phd/week1/LiCoO2/New/Mg-doped/python/refined/basis"
os.environ['ASE_AIMS_COMMAND']="mpirun -np "+os.environ['SLURM_NTASKS']+" /home/scw1057/software/fhi-aims/bin/aims."+os.environ['VERSION']+".scalapack.mpi.x"

# Build molecule
TiO2an = read('Mg-LiCoO2-restart.traj@-1')
...
calc = get_aims_calculator(dimensions=3, k_grid=(5,5,1), xc='libxc MGGA_X_MBEEF+GGA_C_PBE_SOL')
calc.set(
         #spin='none',
	 ...
	 plus_u_use_hydros="True",
         ...
         output=['dos -18 0 200 0.1','atom_proj_dos -18 0 200 0.1','cube eigenstate_density homo','cube eigenstate_density lumo'],
         sc_accuracy_etot=1e-6,
         sc_accuracy_eev=1e-3,
         sc_accuracy_rho=1e-6,
         sc_accuracy_forces=1e-4,
...
# Setup optimisation
dynamics = BFGS(TiO2an, trajectory='Mg-LiCoO2-Optimised.traj')
