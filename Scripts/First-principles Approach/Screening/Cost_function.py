...
#This script is used in Section 3.3.2, to screen the Hubbard parameter space and evaluate the first-principle cost function (J_FP) for all materials specified in References.txt and save as new {material}_with_JFP.txt file
